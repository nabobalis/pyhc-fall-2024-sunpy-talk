...
- New features in v6.0 include:
    ...
    - Standard removal of deprecated features and updated minimum dependencies
- By the numbers:
...
- OpenAstronomy template + SunPy specific functionality == SunPy Package Template [github.com/sunpy/package-template](https://github.com/sunpy/package-template)
  ...
  - Simplified greatly maintenance of 15+ repositories

## Overhaul of the SunPy Project Governance

- Previous structure: Elected Board who appointed key personal like lead developer
- Long process to rewrite SEP-2
- New structure: Elected Project Custodians who then elect a 3 person Steering Committee with an Advisory Board.
- Steering Committee Elected: Stuart Mumford, Laura Hayes & Albert Shih

## ROSES OSTFL 2024 Funding Awarded

- Co-PIs: Albert Shih, Will Barnes, Stuart Mumford, Sam Badman and Kris Someone
